    ...
    <div className="bg-secondary">
      {data ? (
        <div className="fixed w-full h-screen top-0 left-0 bg-black/70 z-40 flex items-center justify-center">
          <div className="w-[90%] 800px:w-[60%] h-[70vh] overflow-y-auto 800px:h-[65vh] bg-white rounded-md shadow-sm relative p-4">
            <RxCross1
              size={20}
            ...
            <div className="block w-full 800px:flex items-center justify-center mx-auto">
              <div className="w-full 800px:w-[50%]">
                ...
                <div
                  className={`${styles.button} bg-black mt-4 rounded-[4px]  bg-transparent border px-2 py-2 h-auto border-primary`}
